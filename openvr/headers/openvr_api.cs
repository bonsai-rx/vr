...
public struct IVRCompositor
{
	...
	[UnmanagedFunctionPointer(CallingConvention.StdCall)]
	internal delegate EVRCompositorError _Submit(EVREye eEye, ref Texture_t pTexture, IntPtr pBounds, EVRSubmitFlags nSubmitFlags);
	[MarshalAs(UnmanagedType.FunctionPtr)]
...
public class CVRCompositor
{
	...
	{
		EVRCompositorError result = FnTable.WaitGetPoses(pRenderPoseArray,(uint) pRenderPoseArray.Length,pGamePoseArray,(uint) (pGamePoseArray == null ? 0 : pGamePoseArray.Length));
		return result;
	}
	...
	public EVRCompositorError Submit(EVREye eEye,ref Texture_t pTexture,IntPtr pBounds,EVRSubmitFlags nSubmitFlags)
	{
		EVRCompositorError result = FnTable.Submit(eEye,ref pTexture,pBounds,nSubmitFlags);
		return result;
	}
